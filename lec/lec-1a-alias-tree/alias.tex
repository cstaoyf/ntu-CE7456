...
\myenums{
    ...
    \myeqn{
        w(e) &=& n \cdot \sum_{\Lambda \in U: e \in \Lambda} v(\Lambda, e) \label{eqn:alias}
    }
    namely, its weight equals $n$ times the sum of its values in all the urns where it appears.
}
