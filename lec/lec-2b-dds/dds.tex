...
%\begin{proof}
    ...
    It is clear that the total computation time of the $i$-th epoch is $O(n \cdot B(s)) = O(n \cdot 2^i)$, i.e., the time to construct $\T$ dominates the time of answering all the queries in the epoch.
