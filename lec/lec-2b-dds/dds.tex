...
A data structure problem parameterized by $(\bD, \bQ)$ to be $(B(n),Q(n))$ is {\em spectrum indexable} if the following property holds on every dataset $S \subseteq \mathbb{D}$:
