...
Let $Q$ be a $k$-cycle with an odd number $k$. In this section, we will give an algorithm to find all its occurrences in a data graph $G$ of $m$ edges in $O(m^{k/2})$ time.
