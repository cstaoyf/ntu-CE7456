...
Note that each interval $J_j$ ($j \in [n]$) has a length of $U/n$, which is never shorter than that of an interval $I_i$ ($i \in [n]$) defined in \eqref{eqn:Ii}. The proposition below follows immediately:
