...
By our construction, for any $(x_1, x_2, ..., x_n) \in \dom(X_1) \times \dom(X_2) \times ... \times \dom(X_n)$, the result of the join $\Q$ must contain a tuple $\bm{u}$ satisfying $\bm{u}(X_j) = x_j$ for each $j \in [n]$. Therefore, the size of $\join(\Q)$ is at least
\myeqn{
