...
The result of the LP (i) cannot be unbounded because clearly $\sum_{e \in \E} \W_e \log |R_e| \ge 0$, and (ii) cannot be empty because setting $\W_e = 1$ for all $e \in \E$ satisfies all the constraints.
