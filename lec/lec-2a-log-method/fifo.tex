...
\myitems{
    \item {\bf Case 1:} In this case, all the elements in every $D$-subset must be older than $e$. Hence, $|D_{h^-}| \le N_e$ because at most $N_e$ elements can be older than $e$.
}
...
Consider any moment before the crossover. At this moment, $e$ is in an $I$-subset; as  we know  The $I$-subset containing $e$ cannot be larger than
