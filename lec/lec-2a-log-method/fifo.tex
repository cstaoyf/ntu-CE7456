...
\begin{lemma} \label{lmm:fact}
    At any moment, every subset --- an $I_i$ or a $D_i$ --- containing $e$ must have a size at most $N_e$.
\end{lemma}
...
\myitems{
    ...
    every $I_i$ or $D_i$ containing $e$ satisfies $2^i \le N_e$, indicating $i \le \log_2 N_e$.
}
